...
FINAL_ANSWER_INSTRUCTIONS = """You are now going to create the final answer to the user's [QUERY] based only in the information found in [CONTEXT] and the conversation between you and the user. Create a highly detailed and accurate answer to solve the [QUERY]. You can use Markdown format. Be clear and concise. Use the same language as the user."""